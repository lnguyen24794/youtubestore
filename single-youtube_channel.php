                    ...
                    <?php while (have_posts()):
                            ...
                            <table class="channel-info-table">
                                <tr>
                                    ...
                                    <td class="channel-info-value">
                                        <?php echo esc_html(number_format($subscribers, 0, ',', '.')); ?></td>
                                </tr>
                                <tr>
                                    <td class="channel-info-label">Giá bán:</td>
                                    <td class="channel-info-value price">
                                        <?php echo esc_html(number_format($price, 0, ',', '.')); ?> VND</td>
                                </tr>
                                <tr>
                        ...
                        <div class="channel-actions-section">
                            <div class="channel-action-buttons">
                                <?php if ($video_url): ?>
                                    <a href="<?php echo esc_url($video_url); ?>" target="_blank"
                                        class="btn-channel-action btn-view-channel">
                                        Xem kênh YouTube
                                    </a>
                                    <button type="button" class="btn-channel-action btn-copy-link"
                                        data-url="<?php echo esc_attr($video_url); ?>">
                                        Sao chép link
                                    </button>
                                <?php endif; ?>
                                <a href="<?php echo esc_url($order_url); ?>" target="_blank"
                                    class="btn-channel-action btn-order-channel">
                                    Đặt mua kênh này
                                </a>
                            </div>
                        </div>
                                    ...
                                    while ($related->have_posts()):
                                        ...
                                        <a href="<?php the_permalink(); ?>" class="related-channel-card">
                                            <div class="related-channel-thumb">
                                                ...
                                                <?php else: ?>
                                                    <img src="<?php echo YOUTUBESTORE_URI; ?>/assets/images/no-image.png"
                                                        alt="<?php the_title(); ?>" />
                                                <?php endif; ?>
                                            </div>
...
<script>
    document.addEventListener("DOMContentLoaded", function () {
        ...
        var copyBtns = document.querySelectorAll('.btn-copy-link');
