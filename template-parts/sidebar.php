...
<div class="col-md-4 tour-list-item">
    ...
    <div class="sidebar-card">
        ...
        <div class="sidebar-search">
            <img src="<?php echo YOUTUBESTORE_URI; ?>/assets/images/home/icon-search.png" alt="icon-search"
                class="sidebar-search-icon" />
            <form role="search" method="get" class="search-form" action="<?php echo home_url('/'); ?>">
                <input type="text" value="<?php echo get_search_query(); ?>" name="s" id="search"
                    placeholder="<?php _e('Search now', 'youtubestore'); ?>" />
            </form>
        </div>
    </div>
                            ...
                            <div class="suggested-post-thumb">
                                ...
                                <?php else: ?>
                                    <img src="<?php echo YOUTUBESTORE_URI; ?>/assets/images/no-image.png"
                                        class="suggested-post-thumb-img" alt="<?php the_title(); ?>" />
                                <?php endif; ?>
                            </div>
